        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="title">
                        <a href="#"><i class="fa fa-fw fa-bar-chart-o"></i> Quản lý thành viên</a>
                    </li>
                    <li>
                        <a href="{!!route('list_user')!!}"><i class="fa fa-fw fa-table"></i>Danh sách thành viên</a>
                    </li>
                    <li>
                        <a href="{!!route('get_add')!!}"><i class="fa fa-fw fa-edit"></i>Thêm thành viên</a>
                    </li>
                    <li class="title">
                        <a href="#"><i class="fa fa-fw fa-desktop"></i> Quản lý form</a>
                    </li>
                    <li>
                        <a href="{!!route('get_list_form')!!}"><i class="fa fa-fw fa-wrench"></i> Danh sách form</a>
                    </li>
                    <li>
                        <a href="{!!route('get_add_form')!!}"><i class="fa fa-fw fa-file"></i>Thêm form</a>
                    </li>
                    <li>
                        <a href="{!!route('get_add_element')!!}"><i class="fa fa-fw fa-dashboard"></i>Thêm thuộc tính form</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
